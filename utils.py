...
def detect_gun(net,output_layers,image, classes, colors):
...
#     with open("./darknet/yolo.names", 'r') as f:
#         classes = [line.strip() for line in f.readlines()]

#     COLORS = np.random.uniform(0, 255, size=(len(classes), 3))

#     # setup net
#     net = cv2.dnn.readNet("./darknet/backup/yolov3.backup", "./darknet/cfg/yolov3.cfg")
